...
#define TEMP_K_TANK 3 //this one is digital
...
// For conditions and cycles, the left bracket remains on the same line, and for functions goes to the next one. C++ thing.
